...
<div class="large-box">
    <form id="login_form" class="fm-v clearfix" action="/mobile/bind" method="post">
        ...
        <div class="wrap1">
            ...
            <button name="loginsubmit" id="loginsubmit" onclick="checkLogin();" type="button" class="on-e-btn">绑定</button>
            <button type="button" class="go-password-btn login_box1"><a href="/mobile/bind_reg" >点我注册</a></button>
        </div>
    </form>
</div>
