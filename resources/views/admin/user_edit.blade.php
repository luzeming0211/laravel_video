            ...
            <div class="tpl-block">
                ...
                <div class="am-g">
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form" method="post" action="/admin/auth/user/{{$userInfo->userid}}">
                            {{ csrf_field() }}
                            <input type="hidden" name="_method" value="put"/>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-form-label">userid <span class="tpl-form-line-small-title"></span></label>
                                <div class="am-u-sm-9">
                                    <input type="text" name="userid" id="userid" value="{{$userInfo->userid}}" readonly>
                                </div>
                            </div>
                            <div class="am-form-group">
...
<script>
    $(function() {
        $('#close_alert').one('click', function() {
