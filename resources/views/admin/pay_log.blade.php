                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <th class="table-type">花费钱</th>
                                    <th class="table-date am-hide-sm-only">时间</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($pay_log as $key => $val)
                                <tr>
                                    <td>{{$val->id}}</td>
                                    <td>{{$val->userid}}</td>
                                    <td>{{$val->username}}</td>
                                    <td class="am-hide-sm-only">{{$val->total_amount}}</td>
                            ...
                            <div class="am-cf">
                                ...
                                <div class="am-fr">
                                    {!!$pay_log->links('vendor.pagination.admin_pa')!!}
                                </div>
                            </div>
                            <hr>
