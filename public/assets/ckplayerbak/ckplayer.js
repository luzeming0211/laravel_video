...
function getUrl(video_url) {
	var key = CryptoJS.enc.Utf8.parse("ckplayerDesKey");
	var iv = CryptoJS.enc.Utf8.parse("ckplayerDesKey");
	var decrypt = CryptoJS.DES.decrypt(video_url, key, {
		iv: iv,
...
! (function() {
	...
	var ckplayer = function(obj) {
		...
		*/
		...
		this.contextMenu = [['返回首页', 'link', 'http://boser1u.top', '_blank'], ['version:X1', 'default', 'line']];
		//全局变量：错误提示列表
	...
	ckplayer.prototype = {
		...
		*/
		embed: function(c) {
			...
			// var videoString1 = getUrl(this.vars['video']);
			// var flag =(videoString1.substr(0, 5));
			// if(flag == "/uplo"){
			// 	var videoString = getUrl(this.vars['video']);
			// }else {
			// 	var videoString = this.vars['video'];
			// }
			var videoString = this.vars['video'];
			// console.log('url地址：'+videoString);
		...
		*/
		analysedVideoUrl: function(video) {
			// console.log(this.typeString(video));
			var i = 0,
			y = 0;
			var thisTemp = this;
